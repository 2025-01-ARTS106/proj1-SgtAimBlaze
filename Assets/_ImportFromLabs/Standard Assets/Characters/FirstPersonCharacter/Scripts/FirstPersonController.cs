...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            {
                //Start climing code.
                //Make forward climb up, backward climb down
                //
                //Allow player to remain still when neutral?
                //Disable left/right movement?
                //Gradual increase in speed when climbing?
                //Can player jump on ladder?
                //Adjust left/right speed?
